...
function PaymentInfoCard({
  ...
  return (
    <div className="mt-2 rounded-xl border border-teal-200 bg-teal-50 p-4 space-y-3 w-full">
...
function ChatPanel({ adminConfig }: { adminConfig: AdminConfig }) {
  ...
  return (
    <div className="flex flex-col h-full min-h-0">
      ...
      {/* Input bar */}
      <div className="flex-shrink-0 border-t border-slate-100 px-3 py-3 pb-[max(12px,env(safe-area-inset-bottom,8px))] flex items-center gap-2">
        <Input
          ref={inputRef}
          value={inputValue}
                  ...
                  <div className="flex gap-1 mt-1">
                    ...
                    <button
                      ...
                      onClick={() => {
                        const updated = {
                          ...cfg,
                          screenshots: cfg.screenshots.filter(
                            (_, idx) => idx !== i,
                          ),
                        };
                        setCfg(updated);
    ...
    <header className="sticky top-0 z-50 bg-black/60 backdrop-blur-md border-b border-white/10">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 flex items-center justify-between h-14">
        ...
        >
          ...
          <span className="font-bold text-white text-lg hidden xs:inline sm:inline">
            PDF Shop
          </span>
        </motion.div>
        ...
        <button
          ...
          className="flex items-center gap-1 text-xs text-white/60 hover:text-amber-300 border border-white/20 hover:border-amber-400 transition-all px-2.5 py-1.5 rounded-md"
...
function Hero() {
  return (
    <section className="text-center pt-6 pb-3 sm:pt-12 sm:pb-6 px-4">
      <motion.div
  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden">
      ...
      <main>
        ...
        <section className="max-w-6xl mx-auto px-4 sm:px-6 pb-6 lg:pb-16">
          <div className="flex flex-col lg:flex-row gap-6 items-start justify-center">
            ...
            <motion.aside
              ...
              className="hidden lg:block w-full lg:w-72 space-y-4"
              data-ocid="pdf.list"
            >
